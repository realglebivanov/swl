  ...
  <div class="row mt-3">
    <div class="col-md-12">
      <div class="input-group mb-3">
        <select
          v-model="ankiStore.form.ankiDeck"
          class="form-select"
          :disabled="ankiStore.decks.length == 0"
        >
          <option selected>Choose an anki deck</option>
          <option
            v-for="ankiDeck in ankiStore.decks"
            :key="ankiDeck"
            :value="ankiDeck"
          >
            {{ ankiDeck }}
        ...
        <input
          v-model="ankiStore.form.newAnkiDeck"
          type="text"
          class="form-control"
        ...
        <button
          ...
          type="button"
          :disabled="!ankiStore.form.newAnkiDeck"
